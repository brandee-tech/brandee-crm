...
export const CompanyRegistrationDialog = ({ open, onOpenChange }: CompanyRegistrationDialogProps) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea 
                      placeholder="Conte-nos mais sobre suas necessidades ou objetivos..."
